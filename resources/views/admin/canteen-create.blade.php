...
@section('content')
    ...
    <div
        ...
        <div class="mb-6 sm:mb-8">
            ...
            <p class="text-base-content/70 text-sm sm:text-lg font-medium">Daftarkan pengelola dan kantin baru ke dalam
                sistem.</p>
        </div>
        ...
        <form action="{{ route('admin.canteen.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div class="alert alert-info bg-blue-50 text-blue-800 border-none rounded-xl text-sm font-medium">
                ...
                <span>Akun pengelola akan dibuat secara otomatis berdasarkan Nama Kantin. Email dan Password akan
                    ditampilkan setelah berhasil ditambahkan.</span>
            </div>
