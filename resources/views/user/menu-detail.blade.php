            ...
            <div class="w-full min-w-0">
                    ...
                    @forelse($otherMenus as $otherMenu)
                        <div class="snap-start shrink-0 w-80 sm:w-72">
                            <x-foodcard 
                                ...
                                :rating="number_format($otherMenu->average_rating, 1)"
                ...
                <div class="mt-12">
                    ...
                    <div class="space-y-4">
                            ...
                            <div class="bg-white border border-base-content/10 rounded-2xl p-4 sm:p-5 shadow-sm">
                                <div class="flex items-start justify-between gap-4 mb-3">
                                    ...
                                    <div class="flex items-center gap-0.5 bg-vanilla-custard-50 px-2 py-1 rounded-lg">
                                        ...
                                        <span class="font-bold text-sm text-base-content">{{ $review->rating }}.0</span>
                                    </div>
                                </div>
                                @if($review->comment)
                        ...
                        @empty
                            <div class="p-6 text-center bg-vanilla-custard-50 border border-base-content/20 rounded-3xl">
