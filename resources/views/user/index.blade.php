...
@section('content')
    ...
    <section class="px-3 sm:px-10 md:px-16 lg:px-24 pb-4">
        <div class="max-w-8xl mx-auto">
            ...
            @php
                $catConfig = [
                    'Makanan' => [
                        ...
                        'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 4v3m0 0a7 7 0 0 0-7 7h14a7 7 0 0 0-7-7zm-8 10h16a1 1 0 0 1 1 1v1H3v-1a1 1 0 0 1 1-1z"/>',
                    ],
                    'Minuman' => [
                        'bg'   => 'bg-emerald-50 hover:bg-emerald-100 border-emerald-200 text-emerald-700',
                        'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M17 8h2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-2M3 8h14v9a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4V8zM6 3v2m4-2v2m4-2v2"/>',
                    ],
                    'Camilan' => [
                        'bg'   => 'bg-vanilla-custard-100 hover:bg-vanilla-custard-200 border-vanilla-custard-300 text-vanilla-custard-800',
                        'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18z M9 9.5H9.01M15 11H15.01M11 15H11.01M14 15H14.01M8 12H8.01"/>',
                    ],
                ];
                $defaultCfg = [
            ...
            @endphp
            <div class="flex items-center justify-center sm:justify-start gap-4 sm:gap-5 overflow-x-auto pb-3 scrollbar-hide -mx-3 px-3 sm:mx-0 sm:px-0">
                {{-- Kategori Dinamis --}}
                @foreach($categories as $cat)
                    ...
                    <a href="{{ route('canteen.index', ['category' => $cat]) }}"
                       class="flex flex-col items-center gap-2 shrink-0 group">
                        <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl border {{ $cfg['bg'] }} flex items-center justify-center shadow-sm group-hover:scale-105 group-hover:shadow-md transition-all duration-200 active:scale-95">
    ...
    <section class="px-3 sm:px-10 md:px-16 lg:px-24 py-10">
        <div class="max-w-8xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                ...
                <!-- Step 1 -->
                <div class="bg-base-100 border border-base-200 rounded-3xl p-6 flex flex-row md:flex-col items-center md:items-center gap-5 md:gap-4 md:text-center shadow-sm hover:-translate-y-1 transition-transform duration-300">
                    <div class="shrink-0 w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-fern-50 flex items-center justify-center text-fern-700">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-base-content/60 font-medium leading-snug">Jelajahi menu favorit dari kantin kampus.</p>
                    </div>
                </div>

                <!-- Step 2 -->
                <div class="bg-base-100 border border-base-200 rounded-3xl p-6 flex flex-row md:flex-col items-center md:items-center gap-5 md:gap-4 md:text-center shadow-sm hover:-translate-y-1 transition-transform duration-300">
                    <div class="shrink-0 w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-vanilla-custard-100 flex items-center justify-center text-fern-800">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-base-content/60 font-medium leading-snug">Selesaikan pembayaran tunai atau online.</p>
                    </div>
                </div>

                <!-- Step 3 -->
                <div class="bg-base-100 border border-base-200 rounded-3xl p-6 flex flex-row md:flex-col items-center md:items-center gap-5 md:gap-4 md:text-center shadow-sm hover:-translate-y-1 transition-transform duration-300">
                    <div class="shrink-0 w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-emerald-50 flex items-center justify-center text-emerald-600">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-base-content/60 font-medium leading-snug">Ambil makananmu setelah pesanan siap.</p>
                    </div>
                </div>
