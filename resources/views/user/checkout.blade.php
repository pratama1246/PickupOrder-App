    ...
    <section class="px-4 sm:px-10 md:px-16 lg:px-24">
        ...
        <form action="{{ route('checkout.store') }}" method="POST" class="max-w-8xl mx-auto flex flex-col lg:flex-row gap-6 lg:gap-8 items-start">
            ...
            <div class="w-full lg:flex-1 min-w-0 space-y-6">
                ...
                <div class="bg-white border border-base-content/20 rounded-3xl p-5 sm:p-6 shadow-sm" x-data="{ selectedTime: 'now' }">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <label class="relative cursor-pointer">
                            ...
                            <div class="rounded-2xl border-2 border-base-content/10 bg-base-100 p-4 text-center hover:bg-base-200 transition-all" :class="selectedTime === 'now' ? 'bg-fern-700 border-fern-700 text-white shadow-md' : 'text-base-content'">
                        ...
                        <label class="relative cursor-pointer">
                            ...
                            <div class="rounded-2xl border-2 border-base-content/10 bg-base-100 p-4 text-center hover:bg-base-200 transition-all" :class="selectedTime === '09.20' ? 'bg-fern-700 border-fern-700 text-white shadow-md' : 'text-base-content'">
                        ...
                        <label class="relative cursor-pointer">
                            ...
                            <div class="rounded-2xl border-2 border-base-content/10 bg-base-100 p-4 text-center hover:bg-base-200 transition-all" :class="selectedTime === '11.30' ? 'bg-fern-700 border-fern-700 text-white shadow-md' : 'text-base-content'">
                        ...
                        <label class="relative cursor-pointer">
                            ...
                            <div class="rounded-2xl border-2 border-base-content/10 bg-base-100 p-4 text-center flex items-center justify-center hover:bg-base-200 transition-all h-full" :class="selectedTime === 'custom' ? 'bg-fern-700 border-fern-700 text-white shadow-md' : 'text-base-content'">
                    ...
                    <div class="mt-4" x-show="selectedTime === 'custom'" x-transition>
                        ...
                        <input type="time" name="custom_time" class="input input-bordered w-full rounded-2xl border-base-content/20 bg-white focus:outline-none focus:border-fern-700 text-base-content" :required="selectedTime === 'custom'">
                    </div>
                </div>
            ...
            <div class="w-full lg:w-[450px] shrink-0 space-y-6">
                ...
                <div class="bg-white border border-base-content/20 rounded-3xl p-5 sm:p-6 shadow-sm">
                    ...
                    <div class="flex gap-3">
                        <a href="/keranjang" class="btn bg-red-500 hover:bg-red-600 text-white border-none flex-1 rounded-2xl font-bold shadow-md active:scale-95 transition-all">
                            Batalkan
                        </a>
                        <button type="submit" class="btn bg-fern-700 hover:bg-fern-800 text-white border-none flex-1 rounded-2xl font-bold shadow-md active:scale-95 transition-all">
                            Konfirmasi Sekarang
                        </button>
                    </div>
                </div>
