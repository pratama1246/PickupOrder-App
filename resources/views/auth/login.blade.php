...
@section('title', 'Login - Sistem Pickup Order PNC')
    ...
    <form action="{{ route('login') }}" method="POST" class="space-y-5">
        ...
        <div>
            ...
            <input type="text" name="identifier" value="{{ old('identifier') }}"
                placeholder="Masukkan Email atau NIM/NIP Anda" autocomplete="username" required
        ...
        <div x-data="{ show: false }">
            ...
            <div class="relative">
                <input :type="show ? 'text' : 'password'" name="password" placeholder="Masukkan password Anda"
                    ...
                    class="input input-bordered w-full rounded-xl bg-white border-base-content/20 focus:outline-none focus:border-fern-600 text-sm font-medium placeholder:text-base-content/35 pr-11
        ...
        <div class="flex items-center justify-between">
            <label class="flex items-center gap-2 cursor-pointer">
                ...
                <span class="text-sm font-medium text-base-content/70">Remember Me</span>
            </label>
            <a href="{{ route('password.request') }}"
                class="text-sm font-bold text-fern-700 hover:text-fern-800 transition-colors">
                Lupa password?
            </a>
        </div>
