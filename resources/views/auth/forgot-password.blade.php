...
@section('form')
    <div class="mb-7">
        ...
        <p class="text-sm text-base-content/60 font-medium">Masukkan NIM/NIP kamu, kami cek dulu ada email-nya atau tidak.
        </p>
    </div>
    ...
    @if (session('status') === 'no-email')
        <div class="bg-amber-50 border border-amber-200 rounded-xl px-4 py-4 mb-5">
            ...
            <p class="text-xs text-amber-600 font-medium">Silakan hubungi admin atau petugas kampus untuk reset password
                secara manual.</p>
        </div>
    @endif
