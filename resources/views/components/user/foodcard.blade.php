<div class="card bg-base-100 w-full shadow-sm rounded-2xl overflow-hidden">
        ...
        <div class="flex-1 min-w-0 flex flex-col justify-between py-0.5">
            <div>
                <div class="flex items-start justify-between gap-1 mb-0.5">
                    <h2 class="font-bold text-sm text-base-content leading-tight line-clamp-1">Nasi Rames</h2>
                    <div class="flex items-center gap-0.5 bg-base-200 px-1.5 py-0.5 rounded-md shrink-0">
                        ...
                        <span class="font-semibold text-xs">4.7</span>
                    </div>
                </div>

                <p class="text-xs text-base-content/55 font-medium mb-1 line-clamp-1">Kantin Bunda Naya</p>

                <p class="text-xs text-base-content/65 leading-snug line-clamp-2">
                    Perpaduan nasi hangat dengan aneka lauk pilihan dan sambal khas yang bikin makan jadi puas.
                </p>
            </div>
    ...
    <div class="hidden sm:block card-body p-4">
        <div class="flex justify-between items-start gap-2">
            <h2 class="font-bold text-base text-base-content leading-tight line-clamp-2">Nasi Rames</h2>
        ...
        <p class="text-sm text-base-content/60 font-medium -mt-1">Kantin Bunda Naya</p>
