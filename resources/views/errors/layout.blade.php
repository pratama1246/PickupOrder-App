...
<body
    ...
    <div class="max-w-3xl w-full px-6 py-12 text-center">
        ...
        <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="{{ url('/') }}"
                class="w-full sm:w-auto px-6 py-3 rounded-2xl bg-fern-700 text-white font-semibold shadow-md hover:bg-fern-800 hover:shadow-lg transition-all active:scale-95 flex items-center justify-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path
