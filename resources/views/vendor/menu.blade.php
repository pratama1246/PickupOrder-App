...
<div class="max-w-8xl">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <h1 class="text-2xl font-bold text-base-content">Daftar Menu</h1>
        ...
        <div class="flex flex-wrap sm:flex-nowrap items-center gap-3">
            ...
            <button class="btn bg-fern-700 hover:bg-fern-800 text-white font-bold text-sm border-none rounded-md px-6 py-2 h-auto min-h-0">
                Tambah Menu
            </button>
        </div>
    </div>
