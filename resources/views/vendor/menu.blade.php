    ...
    <div class="max-w-8xl pb-10 lg:pb-0" id="vendor-menu-container" x-data="initLiveSearch('#vendor-menu-results')">
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
            <div>
                ...
                <p class="text-base-content/70 text-sm sm:text-lg font-medium">Kelola semua menu yang ditawarkan kantin
                    Anda.</p>
            </div>
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-start gap-3 w-full lg:w-auto">
                <form method="GET" action="{{ route('vendor.menu.index') }}" @submit.prevent
                    class="w-full sm:w-64 xl:w-80 grow relative">
                    <label
        ...
        <div id="vendor-menu-results">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                        ...
                        <x-slot:action>
                            <div class="flex items-center gap-3">
                                <a href="{{ route('vendor.menu.edit', $menu->id) }}"
                                    class="text-base-content/60 hover:text-fern-700 transition-colors">
                                ...
                                <button type="button"
                                    onclick="openDeleteModal('{{ addslashes($menu->name) }}', '{{ route('vendor.menu.destroy', $menu->id) }}')"
                ...
                @empty
                    <div
                        class="col-span-full p-8 text-center bg-vanilla-custard-50 border border-base-content/25 rounded-3xl mt-4">
