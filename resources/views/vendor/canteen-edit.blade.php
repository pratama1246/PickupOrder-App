...
<div class="max-w-2xl bg-vanilla-custard-50 border border-base-content/20 rounded-3xl p-6 sm:p-8 mb-10 lg:mb-0 shadow-sm">
    ...
    <div class="mb-6 sm:mb-8 mt-2">
        ...
        <p class="text-base-content/70 text-sm sm:text-lg font-medium">Perbarui informasi, deskripsi, atau foto kantin Anda.</p>
    </div>
    ...
    <form action="{{ route('vendor.canteen.update') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
        ...
        <div>
            ...
            <textarea name="description" rows="4" placeholder="Tuliskan deskripsi atau informasi menarik tentang kantin Anda..."
