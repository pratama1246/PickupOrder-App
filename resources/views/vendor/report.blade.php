    ...
    <div class="max-w-8xl mx-auto space-y-4 sm:space-y-6 pb-10 lg:pb-0">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 sm:mb-8 print:px-0 print:hidden">
            ...
            <button onclick="window.print()"
                class="btn bg-fern-700 hover:bg-fern-800 text-white border-none rounded-xl py-3 h-auto px-6 font-bold shadow-sm active:scale-95 transition-all print:hidden flex items-center justify-center gap-2 w-full sm:w-auto">
